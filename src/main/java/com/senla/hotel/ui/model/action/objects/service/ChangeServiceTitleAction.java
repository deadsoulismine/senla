...
@Component
public class ChangeServiceTitleAction implements IAction {
    ...
    public void execute() throws ObjectNotExistException, ListIsEmptyException {
        ...
        System.out.println("Enter ID of service for change title");
        int idService = utilScanner.intScanner();
        System.out.println("Enter new price");
        String title = utilScanner.stringScanner();
        service.changeServiceTitle(idService, title);
    }
}
